    ...
    public function create_payment(Request $request)
    {
        ...
        $apiContext = new ApiContext(
            new OAuthTokenCredential(
                'ASn7DkBbxOxIOifg18fOiYHLZYWEsEuxffuynGURJsydr6IhEr35QvyIskPbDsIQyZUnHhtef2JM3msW',
                'EJVwnywYeWapYyueJ0mcUXxK3o69-JuMJY3AbhZIagTdcvu4Ru64Wk_F5sike0Af2rpa6yxWhdt6tp4m'
            )
        );
