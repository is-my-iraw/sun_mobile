                            ...
                            <div class="product-item-home product product-item-list {{$key == 5 ? 'hidden_item' :'' }}">
                                ...
                                <div class="product-mid">
                                    <div class="product-image">
                                        <a href="{{route('product_detail',$item->slug)}}"><img
                                                src="{{$item->thumbnail}}"
                                    ...
                                    <div class="product-price ">
                                        <b>{{number_format($item->price - $item->price * $item->discount/100 )}} vnđ</b><span
                                            style="display: {{$item->discount == 0 ? 'none' :''}}"><del>{{number_format($item->price) }} vnđ</del></span>
                                    </div>
                                </div>
