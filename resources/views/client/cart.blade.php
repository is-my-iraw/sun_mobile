        ...
        <div class="col-12 m-0 p-0">
                ...
                @foreach($list as $index=>$item)
                    <div id="cart2_id_{{$item->id}}" style="height: 125px" class="col-12 col-sm-12 col-md-6 p-1">
                        <div style="height: 100%; width: 100%;position: relative" class="border row m-0 p-0">
                            <div onclick="document.getElementById('price_id_{{$item->id}}').click();is_checked(this)"
                                 style="z-index: 100;cursor: pointer;height: 23px;width: 23px;border-radius: 50%;position: absolute;bottom: 3px ; right: 3px;border: 1px #747474 solid" class="p-1 checked_option2"></div>
            ...
            <div class="border col-12 row m-0 p-0" style="">
                <div class="col-12 col-xl-6 col-md-6 col-sm-12 d-flex align-items-center">
                    <button onclick="get_id()" data-toggle="modal" data-target="#exampleModal1"
                            class="btn btn-primary m-auto btn_checkout"
                            style="width: 150px;margin-top: 5px!important;margin-bottom: 5px!important;" disabled>
                        Mua hàng
                    </button>
                </div>
                <div class="col-12 col-xl-6 c0l-md-6 col-sm-12 d-flex justify-content-center align-items-center">
                    <p class="text_mini" style="font-size: 18px;font-weight: bold">
                        thanh toan: <span class="show_price_is_choice">{{number_format($total_price)}}</span>vnđ / Tổng
                        số : <span
                            class="show_total_price"> {{number_format($total_price)}}</span>
                    </p></div>
            </div>
        </div>
    </section>
