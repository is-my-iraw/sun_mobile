                    ...
                    <div style="height: 150px" class="col-12 col-xl-6 col-md-6 col-sm-12 border mt-2 p-2">
                        <div style="height: 80%" class="">
                            ...
                            <p class="pl-2 pt-1" style="font-weight: 400;font-size: 14px"><span
                                    style="display: inline-block;transform: translateY(2px);margin-right: 3px;background:
                                    {{\App\Models\Color::find(\App\Models\Product_option::find($item->product_option_id)->color_id)->color_code}};height: 13px;width: 13px"></span>{{\App\Models\Product::find(\App\Models\Product_option::find($item->product_option_id)->product_id)->name}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Mã số thẻ : <span style="font-weight: 600">95118122002</span></p>
                        <p>Ngân hàng : <span style="font-weight: 600">TP Bank</span></p>
                        <p>Họ tên chủ thẻ : <span style="font-weight: 600">Phung Manh Quan</span></p>
